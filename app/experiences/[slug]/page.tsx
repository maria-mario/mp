...
import { getAllExperiences, getExperienceBySlug, getRelatedExperiences } from '@/lib/data/experiences';
  ...
  return (
    <main>
      ...
      <section style={{
        ...
        <div className="container" style={{ position: 'relative', zIndex: 10, paddingBottom: '4rem', paddingTop: '8rem' }}>
          <span className={
            exp.type === 'core' ? 'badge-core' :
            exp.type === 'premium-request' ? 'badge-premium-request' :
            'badge-premium'
          }>
            {exp.label_text}
          </span>
      ...
      <section className="section" style={{ backgroundColor: 'var(--color-brand-off-white)' }}>
        <div className="container" style={{ maxWidth: '720px' }}>
          <InclusionFlag type={exp.type} heading={exp.inclusion_heading} body={exp.inclusion_body} />
        </div>
      </section>
      ...
      <section className="section section-dark">
        <div className="container">
          <div className="section-divider" style={{ backgroundColor: 'var(--color-brand-sienna)' }} />
      ...
      {/* ── TESTIMONIAL — only if real quote exists ── */}
      {exp.testimonial_quote && (
        <section className="section" style={{ backgroundColor: 'var(--color-brand-off-white)', textAlign: 'center' }}>
          <div className="container" style={{ maxWidth: '640px' }}>
            <blockquote style={{
        ...
        <div className="container">
          <div style={{
            ...
            <div className="section-dark" style={{
              ...
              <h3 style={{ color: '#ffffff', marginBottom: '0.75rem', fontSize: 'var(--text-title)' }}>
                {exp.primary_cta_heading}
              </h3>
              <p style={{ color: 'rgba(255,255,255,0.75)', marginBottom: '2rem', fontSize: 'var(--text-small)', lineHeight: 1.75, maxWidth: '100%' }}>
                {exp.primary_cta_body}
              </p>
              <Link href="/forum-retreats#inquiry" className="btn-primary" style={{ width: '100%', justifyContent: 'center' }}>
            ...
            <div className="card" style={{ padding: '2.5rem' }}>
              <h3 style={{ marginBottom: '0.75rem', fontSize: 'var(--text-title)' }}>
                {exp.secondary_cta_heading}
              </h3>
              <p style={{ color: 'var(--color-brand-text-muted)', marginBottom: '1.5rem', fontSize: 'var(--text-small)', lineHeight: 1.75, maxWidth: '100%' }}>
