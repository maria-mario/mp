      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          {benefits.map((benefit) => (
            <div key={benefit.title} className="card group p-8">
              {/* Icon */}
              <div
              ...
              >
                <benefit.icon
                  ...
                  style={{ color: 'var(--color-brand-sienna)' }}
                />
              </div>
        ...
        <div className="text-center">
          <Link href="/forum-retreats" className="btn-primary inline-flex items-center gap-2 group">
